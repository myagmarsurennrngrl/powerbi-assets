...
export const mn = {
  ...
  errors: {
    ...
    configMissing:
      'Аппын тохиргоо дутуу эсвэл буруу байна. (.env файл)',
    configHint:
      'Компьютер дээрх .env файлыг нээж шалгана уу: хашилтгүй байх, мөрийн төгсгөлд зайгүй байх, ' +
      'хаяг https:// -ээр эхлэх ёстой. Зассаны дараа серверийг дахин асаана: npx.cmd expo start -c',
  },
} as const;
